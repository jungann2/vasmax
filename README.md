...
2.  卸载 VasmaX                 10. 核心管理（启动/停止核心）
3.  安装管理（安装/卸载协议）    11. Xboard-Plus 对接管理
4.  账号管理                    12. TLS 证书管理
5.  分流工具                    13. 系统工具（BBR/DNS/伪装站/诊断）
6.  CDN 管理                    14. 实时监控
7.  订阅管理                    15. VasmaX 服务管理
8.  额外端口管理                0.  退出
16. 协议参数管理（Reality/Hysteria2/TUIC）
```

> 💡 v2.2.8 起菜单精简：原 BT/黑名单独立入口合并进「5 分流工具」子菜单，编号顺移。老用户请留意新编号。
