...
- 15 种协议组合一键安装管理
- Xboard-Plus 面板对接：用户同步、流量统计、在线追踪
- 独立模式：无需面板，单机运行
...
```
1.  更新 VasmaX                 10. 额外端口管理
2.  卸载 VasmaX                 11. ALPN 切换
3.  安装管理（安装/卸载协议）    12. 核心管理（启动/停止核心）
4.  账号管理                    13. Xboard-Plus 对接管理
5.  分流工具                    14. TLS 证书管理
6.  BT 下载管理                 15. 其他工具
7.  域名黑名单                  16. 实时监控
8.  CDN 管理                    17. VasmaX 服务管理
9.  订阅管理                    0.  退出
18. 协议专项管理（Reality/Hysteria2/TUIC）
```
...
- Reality：修改伪装域名、查看/重新生成 Reality 密钥
